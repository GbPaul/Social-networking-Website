...
mysql_query("UPDATE profile SET city ='$_POST[city]',	state='$_POST[state]',postcode='$_POST[postcode]',country='$_POST[loc]',hschool='$_POST[hschool]',coluni='$_POST[coll]',course='$_POST[hschool2]'
